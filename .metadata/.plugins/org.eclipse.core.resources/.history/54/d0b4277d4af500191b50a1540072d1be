...
@SpringBootTest(webEnvironment=WebEnvironment.RANDOM_PORT)
 public class HackathonApplicationTests {
    ...
    int randomServerPort;
	 ...
	 public void testAuthenticateUserSuccess() throws URISyntaxException {
		...
		final String baseUrl = "http://localhost:"+randomServerPort+"/user/authenticate/1/1";
	 ...
	 @Test
	 public void testvalidateRegistrationForm() throws URISyntaxException {
		RestTemplate restTemplate = new RestTemplate();
	     
		final String baseUrl = "http://localhost:"+randomServerPort+"/user/validateRegistrationForm/5/5";
        URI uri = new URI(baseUrl);
 ...
 public void testsaveCustomer() throws URISyntaxException {
		...
		final String baseUrl = "http://localhost:"+randomServerPort+"/address/saveCustomer/satya/2/2";
       URI uri = new URI(baseUrl);
